...
# File path templates
pheno_template <- file.path(base_dir, "PhenotypeSimulated_singleSNP_h20005_UHetero1sc_sampledSNP_%d.txt")
se2_template <- file.path(base_dir, "PhenotypeSimulated_singleSNP_residSE2_h20005_UHetero1sc_sampledSNP_%d.txt")
...
pheno_template <- "PhenotypeSimulated_singleSNP_h2%s_FITmeanvarSC_sampledSNP_%d.txt"
se2_template <- "PhenotypeSimulated_singleSNP_residSE2_h2%s_FITmeanvarSC_sampledSNP_%d.txt"
...
plot(x = plotting_data$value, y = plotting_data$se2, 
     ...
     main = "Mean-Variance Relationship for Simulated Trait Data with fitted mean-variance relationship: h2 = 0.025, sim 1")
...
results_file <- file.path(output_dir, "GEMMA_DefvModTesting_FITMEAN_NOSHRINKAGE_power_results.Rda")
