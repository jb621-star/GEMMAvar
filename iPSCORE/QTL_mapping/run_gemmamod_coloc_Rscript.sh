...
#SBATCH --job-name=gemmamod_coloc
#SBATCH --output=gemmamod_coloc.out
#SBATCH --error=gemmamod_coloc.err
...
Rscript GEMMAmod_res_coloc_Rscript.R
...
echo "Completed GEMMAmod colocalization"