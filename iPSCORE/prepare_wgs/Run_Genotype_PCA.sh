...
#SBATCH --job-name=runGenoPCA
#SBATCH --error=runGenoPCA.err
...
#cmd="plink2 --threads 8 --bfile ${outdir}/pca/input/ipscore.to_pca --make-bed --out ${outdir}/pca/input/ipscore.to_pca.renamed --set-all-var-ids @:#:\\\$1:\\\$2 --new-id-max-allele-len 367"
#echo $cmd >> $log; echo $cmd; eval $cmd
...
awk -F "\t" '{print 0,$1,$6}' /data/irb/biostatisticsbioinformatics/pro00117530/GEMMAmod_iPSCORE/reference/igsr-1000genomes_grch38-samples.tsv | tail -n +2 > ${pca_dir}/within.txt
project=ipscore
