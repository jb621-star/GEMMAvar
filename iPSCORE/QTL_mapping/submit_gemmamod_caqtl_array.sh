...
##   sbatch --array=1-10000%400 --export=OFFSET=10000 submit_gemmamod_caqtl_array.sh
## ============================================================
...
PEAK=$(sed -n "${ACTUAL_IDX}p" caqtl_gene_inputs/peak_list.txt)
...
echo "Task ${SLURM_ARRAY_TASK_ID} | Offset ${OFFSET} | Index ${ACTUAL_IDX} | Model: ${MODEL} | Peak: ${PEAK}"
